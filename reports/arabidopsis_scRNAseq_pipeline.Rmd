...
\begin{center}
```
![Trajectory graph colored by cell type.](../results/09_pseudotime/trajectory/n50_s0.3_l200_e8_seed3/n50_s0.3_l200_e8_seed3_annotation.pdf){width=30%} ![Pseudotime overlaid on the force-directed layout.](../results/09_pseudotime/trajectory/n50_s0.3_l200_e8_seed3/n50_s0.3_l200_e8_seed3_pseudotime_trajectory.pdf){width=30%}
```{=latex}
\end{center}
```

![Root cell (red) automatically selected within the Epidermis cluster as the most-connected cell — pseudotime = 0 here.](../results/09_pseudotime/trajectory/n50_s0.3_l200_e8_seed3/n50_s0.3_l200_e8_seed3_root_cell.pdf){width=30%}
...
![Selected genes on the trajectory layout.](../results/09_pseudotime/trajectory/n50_s0.3_l200_e8_seed3/gene_plots/n50_s0.3_l200_e8_seed3_gene_plots.pdf){width=30%}
