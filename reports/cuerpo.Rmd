...
epidermis alone (the bibliography annotation no longer splits it into
Cotyledon/guard-cell subtypes). Names must match the Section 24 list exactly.
...
![Root cell (red) automatically selected within the Epidermis cluster as the most-connected cell — pseudotime = 0 here.](assets/pseudotime_root_cell.pdf){width=30%}
...
\begin{center}
```
![Top 10 variable genes along pseudotime.](assets/pseudotime_gene_trends.pdf){width=48%} ![Highlighted gene list along pseudotime.](assets/pseudotime_gene_trends_highlight.pdf){width=48%}
```{=latex}
\end{center}
```
