...
samples <- list(
  list(file = "cellranger_v2/scDS1a/outs/filtered_feature_bc_matrix", label = "scDS1a", condition = "condition_1"),
  list(file = "cellranger_v2/scDS1b/outs/filtered_feature_bc_matrix", label = "scDS1b", condition = "condition_1"),
  list(file = "cellranger_v2/scDS2a/outs/filtered_feature_bc_matrix", label = "scDS2a", condition = "condition_2"),
  list(file = "cellranger_v2/scDS2b/outs/filtered_feature_bc_matrix", label = "scDS2b", condition = "condition_2")
)
