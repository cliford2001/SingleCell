# =============================================================================
# capitulo1_single_cell_reference_backup.R — BACKUP, NOT the active pipeline
# =============================================================================
# Full snapshot of capitulo1_single_cell.R kept for reference. Includes the
# reference-transfer annotation strategy (Section 8b: annotate_by_reference()
# against a published Seurat object, e.g. GSE273033) and every downstream
# step wired to pbmc_harmony$celltype_reference (Sections 9-11).
#
# The active pipeline (capitulo1_single_cell.R) dropped this strategy and
# now runs on pbmc_harmony$celltype (bibliography-based annotation) only.
# Restore reference-transfer annotation by copying Section 8b from this file
# back into the active script and re-pointing celltype_reference downstream.
# =============================================================================
#
